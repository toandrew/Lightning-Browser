...
public class LightningView {
    ...
    public LightningView(Activity activity, String url) {
         ...
         * LightningDownloadListener(activity));
         */
    ...
    public void setColorMode(int mode) {
        ...
        case 3:
            ...
            ColorMatrixColorFilter filterInvertGray = new ColorMatrixColorFilter(
                    concat);
    ...
    public synchronized void goBack() {
        if (mWebView != null) {
            mWebView.getNavigationHistory().navigate(
                    XWalkNavigationHistory.Direction.BACKWARD, 1);
        }
    }

    public String getUserAgent() {
        return getWebViewUserAgent(mWebView);
        // if (mWebView != null) {
    ...
    public boolean canGoForward() {
        return mWebView != null
                && mWebView.getNavigationHistory().canGoForward();
    }
