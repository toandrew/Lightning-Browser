...
public class MyFlintVideoManager {
    private static final String TAG = MyFlintVideoManager.class.getSimpleName();
    ...
    private void setupPicker() {
        ...
        mDevicePicker = new DevicePicker((SenderDemo) mContext);
        ...
        mPairingAlertDialog = new AlertDialog.Builder((SenderDemo) mContext)
        ...
        final EditText input = new EditText((SenderDemo) mContext);
        input.setInputType(InputType.TYPE_CLASS_NUMBER);

        final InputMethodManager imm = (InputMethodManager) mContext
                .getSystemService(Context.INPUT_METHOD_SERVICE);

        mPairingCodeDialog = new AlertDialog.Builder((SenderDemo) mContext)
    ...
    public void setTv(ConnectableDevice tv) {
        if (tv == null) {
            ...
            playVideo(((SenderDemo) mContext).getCurentVideoUrl(),
                    ((SenderDemo) mContext).getCurrentVideoTitle());
        }
    }
