...
public class FlintVideoManager {
    ...
    private CrossKrFlintManager mCrossKrFlintManager;
    ...
    public FlintVideoManager(CrossKrFlintManager flintManager, String applicationId,
            FlintStatusChangeListener listener) {

        mCrossKrFlintManager = flintManager;
    ...
    public void doMediaRouteButtonClicked() {
        if (mCrossKrFlintManager.getCurrentVideoUrl() == null) {
            Toast.makeText(mCrossKrFlintManager.getContext(), mCrossKrFlintManager.getContext().getString(R.string.flint_empty_video_url), Toast.LENGTH_SHORT)
            .show();
            return;
        }
    ...
    private void setupPicker() {
        ...
        mDevicePicker = new DevicePicker(mCrossKrFlintManager.getActivity());
        ...
        mPairingAlertDialog = new AlertDialog.Builder(mCrossKrFlintManager.getActivity())
        ...
        final EditText input = new EditText(mCrossKrFlintManager.getActivity());
        input.setInputType(InputType.TYPE_CLASS_NUMBER);

        final InputMethodManager imm = (InputMethodManager) mCrossKrFlintManager.getActivity()
                .getSystemService(Context.INPUT_METHOD_SERVICE);

        mPairingCodeDialog = new AlertDialog.Builder(mCrossKrFlintManager.getActivity())
